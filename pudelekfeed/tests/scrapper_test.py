...
class ScrapperTest(unittest.TestCase):
    ...
    def test_create_date_should_return_expected_value(self):
        self.new_date = self.scrapper.create_date(self.date)
        self.assertEqual(self.new_date, '2019-09-21 12:30:00')
